...
public final class FragmentGalleryBinding implements ViewBinding {
  ...
  private FragmentGalleryBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView imageListRecyclerView) {
  ...
  public static FragmentGalleryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RecyclerView imageListRecyclerView = rootView.findViewById(id);
      if (imageListRecyclerView == null) {
        break missingId;
      }

      return new FragmentGalleryBinding((ConstraintLayout) rootView, imageListRecyclerView);
    }
